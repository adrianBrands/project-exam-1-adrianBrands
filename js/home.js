...
function displayresults (results){
    for(let i = 0; i < results.length; i++) {
        switch (results[i]) {
            ...
            case results[2]:
            case results[3]:
        carousel1.innerHTML += `<div class="carousel_item"><img class="post_img" src="${results[i]._embedded['wp:featuredmedia']['0'].source_url}"/>
            ...
            case results[6]:
            case results[7]:
        carousel2.innerHTML += `<div class="carousel_item"><img class="post_img" src="${results[i]._embedded['wp:featuredmedia']['0'].source_url}"/>
                                   <h2>${results[i].title.rendered}</h2>
                                   <p>${results[i].date}</p>
                                   <a href="article.html?id=${results[i].id}" <button>read</button></a></div>`;
                                   break; 
            ...
            case results[10]:
            case results[11]:
        carousel3.innerHTML += `<div class="carousel_item"><img class="post_img" src="${results[i]._embedded['wp:featuredmedia']['0'].source_url}"/>
                                   <h2>${results[i].title.rendered}</h2>
                                   <p>${results[i].date}</p>
                                   <a href="article.html?id=${results[i].id}" <button>read</button></a></div>`;
        }
